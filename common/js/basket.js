...
*/(function (window, document) {
  ...
  const injectStyle = function (obj) {
  ...
  window.basket = {
    ...
    expireHandler: function (expire) {
      if (typeof expire !== "number") throw new Error("自定义缓存时间expire参数错误，它必须是一个数字,将使用默认5000小时");
      defaultExpiration = typeof expire === "number" ? expire : defaultExpiration;
    }
  };
