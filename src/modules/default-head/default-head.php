...
<link rel="mask-icon" href="<?php $this->options->themeUrl('/images/favicon/safari-pinned-tab.svg');?>" color="#5bbad5">
<link rel="shortcut icon" href="<?php $this->options->themeUrl('/images/favicon/favicon.ico');?>">
<meta name="msapplication-TileColor" content="#2d89ef">
<meta name="msapplication-config" content="<?php $this->options->themeUrl('/images/favicon/browserconfig.xml');?>">
