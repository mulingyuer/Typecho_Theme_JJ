    ...
    <div class="article-detail-recommended-content">
        <a class="article-detail-recommended-link" href="<?php echo $articleDetailRecommended['permalink']; ?>" itemprop="url" target="_blank" title="<?php echo $articleDetailRecommended['title']; ?>">
          ...
          <?php if (!empty($articleDetailRecommended['thumb'])): ?>
            <img class="article-detail-recommended-item-img" src="<?php $this->options->themeUrl('/images/home_recommended_article_loading.gif');?>" data-src="<?php echo $articleDetailRecommended['thumb']; ?>" data-error="<?php $this->options->themeUrl('/images/loading_error.gif');?>" alt="<?php echo $articleDetailRecommended['title']; ?>">
          <?php else: ?>
            <img class="article-detail-recommended-item-img" src="<?php $this->options->themeUrl('/images/home_recommended_article_loading.gif');?>" data-src="<?php $this->options->themeUrl('/images/home_recommended_article_empty.jpg');?>" alt="<?php echo $articleDetailRecommended['title']; ?>">
          <?php endif;?>
