 ...
 * @FilePath: /Typecho_Theme_JJ/src/modules/post/article-detail-recommended/index.ts
 * 怎么可能会有bug！！！
 */
import "./style.scss";
import ThumbLazy from "@/modules/article-card/thumbLazy";
import type { LazyTarget } from "@/modules/article-card/thumbLazy";
