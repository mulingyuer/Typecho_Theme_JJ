...
<meta property="og:image" content="<?php themeUrl('static/images/favicon/favicon.ico');?>"/>
<meta property="og:description" content="<?php $this->options->description() ?>">
<meta name="applicable-device" content="pc,mobile" />
<meta http-equiv="Cache-Control" content="no-transform" />
<link rel="shortcut icon" href="<?php themeUrl('static/images/favicon/favicon.ico');?>" />
<?php if($this->is('post')) : ?>
