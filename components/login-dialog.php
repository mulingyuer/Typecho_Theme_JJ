      ...
      <form class="auth-form" action="<?php $this->options->loginAction() ?>" method="post" name="login" rold="form">
        ...
        <div class="form-panel">
          ...
          <div class="input-group username">
            ...
            <img class="panfish-img greeting" src="<?php themeUrl('common/images/login/greeting.png');?>">
          </div>
          <div class="input-group password">
            <input type="password" name="password" placeholder="请输入密码" required pattern="\S+.*">
            <img class="panfish-img blindfold" src="<?php themeUrl('common/images/login/blindfold.png');?>">
          </div>
          <div class="input-group">
            <button class="btn">登录</button>
          </div>
          <img class="panfish-img normal" src="<?php themeUrl('common/images/login/normal.png');?>">
        </div>
