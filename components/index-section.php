<section class="entry-card" data-link="<?php $this->permalink() ?>">
  ...
  <?php if($thumbnail !== ""): ?>
  <div class="entry-img">
    <img data-src="<?php echo $thumbnail;?>" src="<?php themeUrl('common/images/tool/img-loading.gif');?>" alt="<?php $this->title() ?>">
  </div>
  <?php endif;?>
</section>