<div class="right">
  ...
  <div class="theme-tool">
    <div class="item">
      <a class="link" href="https://www.yuque.com/mulingyuer/ohl5ed" target="_blank">
        <div class="tool-pic">
          <img src="<?php themeUrl('static/images/tool/faq.png');?>" alt="faq">
        </div>
    ...
    <div class="item">
      <a class="link" href="<?php $this->options->feedUrl(); ?>" target="_blank">
        <div class="tool-pic">
          <img src="<?php themeUrl('static/images/tool/article-rss.png');?>" alt="文章RSS订阅">
        </div>
    ...
    <div class="item">
      <a class="link" href="<?php $this->options->commentsFeedUrl(); ?>" target="_blank">
        <div class="tool-pic">
          <img src="<?php themeUrl('static/images/tool/comments-rss.png');?>" alt="文章RSS订阅">
        </div>
  ...
  <?php //footer?>
  <?php $this->need("components/default/footer.php");?>
</div>