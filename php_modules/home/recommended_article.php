        ...
        <a class="recommended-article-item-link" href="<?php echo $item['permalink']; ?>" itemprop="url" target="_blank" title="<?php echo $item['title']; ?>">
          <div class="recommended-article-item">
            <?php if ( ! empty($item['thumb'])): ?>
              <img class="recommended-article-item-img" src="<?php echo $item['thumb']; ?>" alt="<?php echo $item['title']; ?>">
            <?php else: ?>
              <img class="recommended-article-item-img" src="<?php $this->options->themeUrl('/static/images/home_recommended_article_empty.jpg');?>" alt="<?php echo $item['title']; ?>">
            <?php endif;?>
